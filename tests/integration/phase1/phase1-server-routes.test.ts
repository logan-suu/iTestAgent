...
const localNetworkDisabled = !canBindLocalServer();

beforeAll(async () => {
  if (localNetworkDisabled) return;
...
describe.skipIf(localNetworkDisabled)(
  'Phase 1 Integration: Server Routes (Bun.serve → Routes → SessionManager)',
  () => {
