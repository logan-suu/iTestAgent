...
CLI          Commander（轻量入口）
TUI          OpenTUI / Rezi / Ink（候选横评，第一版至少跑通一路）
...
候选横评   OpenTUI+Rezi+Ink / mobile-mcp+Appium+iphone-use / XcodeTraceMCP+instrumentsmcp+raw xcrun / Drizzle+Kysely / XcodeQuery+XcodeProj
